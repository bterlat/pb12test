HA$PBExportHeader$w_welcome.srw
...
ls_database = "ConnectString='DSN=EAS Demo DB V120;"			
...
event help;ShowPopupHelp("pbtutor.hlp", this, 200)
end event
...
event help;ShowPopupHelp("pbtutor.hlp", this, 100)
end event

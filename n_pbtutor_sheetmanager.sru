HA$PBExportHeader$n_pbtutor_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_pbtutor_sheetmanager from nonvisualobject
end type
end forward

global type n_pbtutor_sheetmanager from nonvisualobject
end type
global n_pbtutor_sheetmanager n_pbtutor_sheetmanager

type variables
string is_sheets[], is_display[]
w_pbtutor_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_pbtutor_basesheet aw_sheet)
...
w_pbtutor_basesheet lw_sheets[], lw_init[]
...
lm_menu = w_pbtutor_frame.MenuId
...
on n_pbtutor_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_pbtutor_sheetmanager.destroy

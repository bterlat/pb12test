HA$PBExportHeader$w_pbtutor_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_pbtutor_frame from window
end type
type mdi_1 from mdiclient within w_pbtutor_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_pbtutor_frame"
...
global w_pbtutor_frame w_pbtutor_frame

type variables
n_pbtutor_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_pbtutor_basesheet aw_sheet)
public function long of_classcount (readonly w_pbtutor_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_pbtutor_frame am_menu)
end prototypes
...
//*-----------------------------------------------------------------*/
string ls_sheets[], ls_display[]

/*  Register sheet windows with sheet manager  */
ls_sheets[1] = "w_customers"
ls_sheets[2] = "w_products"
ls_sheets[3] = "w_cust_pct"

ls_display[1] = "Maintain Customers"
ls_display[2] = "Maintain Products"
...
inv_sheetmgt = Create n_pbtutor_sheetmanager
...
on w_pbtutor_frame.create
if this.MenuName = "m_pbtutor_frame" then this.MenuID = create m_pbtutor_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_pbtutor_frame.destroy

HA$PBExportHeader$n_pbtutor_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_pbtutor_connectservice from nonvisualobject
end type
end forward

global type n_pbtutor_connectservice from nonvisualobject
end type
global n_pbtutor_connectservice n_pbtutor_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "C:\Program Files\Sybase\PowerBuilder 12.0\Tutorial\pbtutor.ini"
...
//		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=EAS Demo DB V120;UID=dba;PWD=sql'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=EAS Demo DB V120;UID=dba;PWD=sql'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logpass		= ""
		as_server		= ""
		as_dbparm		= "ConnectString='DSN=EAS Demo DB V120;UID=dba;PWD=sql'"
		as_lock			= ""
		as_autocommit	= "false"
...
on n_pbtutor_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_pbtutor_connectservice.destroy
